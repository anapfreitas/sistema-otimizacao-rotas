...
with open(os.path.join(dados_dir, "top3_aco.json"), "r", encoding="utf-8") as f:
    dados = json.load(f)
...
nomes = ["ACO Rota 1", "ACO Rota 2", "ACO Rota 3"]
...
gerar_html("mapa_rotas_aco.html", rotas, nomes, metricas)


for i in range(3):
    gerar_html(f"mapa_rota_aco_{i+1}.html", [rotas[i]], [nomes[i]], [metricas[i]], deslocar=False)
